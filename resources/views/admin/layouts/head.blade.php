<meta charset="utf-8" />
    ...
    <title>Dashboard - Style Stride</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('template/backend/assets/vendor/css/core.css') }}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('template/backend/assets/vendor/css/theme-default.css') }}" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="{{ asset('template/backend/assets/vendor/libs/apex-charts/apex-charts.css') }}" />
