<header id="header" class="header-color-white">
    <div class="container">
        <div class="header-inner">
            <div class="branding">
                <h1 class="logo">
                    <a href="index.html"><img src="images/logo@2x.png" alt=""><span>Style Stride</span></a>
                </h1>
            </div>
            <nav id="nav">
                        ...
                        <div class="sub-nav cart-content">
                            ...
                            <div class="st-table">
                                <div class="cart-action">
                                    <a href="woocommerce-shopping-cart.html" class="btn-view-cart btn btn-sm style4"><i
                    ...
                    <li class="menu-item-has-children mega-menu-item mega-column-4">
                        ...
                        <ul class="sub-nav">
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-nav">
                                    <li><a href="shortcode-accordion-toggles.html"><i
                                                class="fa fa-caret-square-o-right"></i><span>Accordion &
                                                Toggles</span></a></li>
                                    <li><a href="shortcode-animations.html"><i
                                                class="fa fa-spinner"></i><span>Animations</span></a></li>
                                    <li><a href="shortcode-blog-posts.html"><i
                                                class="fa fa-file-text-o"></i><span>Blog Posts</span></a></li>
                                    <li><a href="shortcode-buttons.html"><i
                                                class="fa fa-link"></i><span>Buttons</span></a></li>
                                    <li><a href="shortcode-dropdown.html"><i
                                                class="fa fa-bars"></i><span>Dropdowns</span></a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#">Miracle Elements</a>
                                <ul class="sub-nav">
                                    <li><a href="shortcode-form-layouts.html"><i class="fa fa-tasks"></i><span>Form
                                                Layouts</span></a></li>
                                    <li><a href="shortcode-galleries.html"><i
                                                class="fa fa-picture-o"></i><span>Galleries</span></a></li>
                                    <li><a href="shortcode-icon-styling.html"><i class="fa fa-adjust"></i><span>Icon
                                                Styling</span></a></li>
                                    <li><a href="shortcode-interactive-banners.html"><i
                                                class="fa fa-list-alt"></i><span>Interactive Banners</span></a></li>
                                    <li><a href="shortcode-process.html"><i
                                                class="fa fa-cog"></i><span>Process</span></a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#">Miracle Elements</a>
                                <ul class="sub-nav">
                                    <li><a href="shortcode-post-sliders.html"><i
                                                class="fa fa-picture-o"></i><span>Posts Sliders</span></a></li>
                                    <li><a href="shortcode-pricing-tables.html"><i
                                                class="fa fa-table"></i><span>Pricing Tables</span></a></li>
                                    <li><a href="shortcode-progress-bars.html"><i
                                                class="fa fa-bar-chart-o"></i><span>Progress Bars</span></a></li>
                                    <li><a href="shortcode-style-changer.html"><i
                                                class="fa fa-exchange"></i><span>Style Changer</span></a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
                                <a href="#">Miracle Elements</a>
                                <ul class="sub-nav">
                                    <li><a href="shortcode-tabs.html"><i class="fa fa-list"></i><span>Tabs</span></a>
                                    </li>
                                    <li><a href="shortcode-team.html"><i class="fa fa-user"></i><span>Team
                                                Members</span></a></li>
                                    <li><a href="shortcode-testimonials.html"><i
                                                class="fa fa-comment"></i><span>Testimonials</span></a></li>
                                    <li><a href="shortcode-typography.html"><i
                                                class="fa fa-print"></i><span>Typography</span></a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="mobile-nav-wrapper collapse visible-mobile" id="mobile-nav-wrapper">
        <ul class="mobile-nav">
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="sub-nav">
                    <li><a href="shortcode-accordion-toggles.html"><i
                                class="fa fa-caret-square-o-right"></i><span>Accordion & Toggles</span></a></li>
                    <li><a href="shortcode-animations.html"><i class="fa fa-spinner"></i><span>Animations</span></a>
                    </li>
                    <li><a href="shortcode-blog-posts.html"><i class="fa fa-file-text-o"></i><span>Blog
                                Posts</span></a></li>
                    ...
                    <li><a href="shortcode-form-layouts.html"><i class="fa fa-tasks"></i><span>Form Layouts</span></a>
                    </li>
                    <li><a href="shortcode-galleries.html"><i class="fa fa-picture-o"></i><span>Galleries</span></a>
                    </li>
                    <li><a href="shortcode-icon-styling.html"><i class="fa fa-adjust"></i><span>Icon
                                Styling</span></a></li>
                    <li><a href="shortcode-interactive-banners.html"><i class="fa fa-list-alt"></i><span>Interactive
                                Banners</span></a></li>
                    <li><a href="shortcode-process.html"><i class="fa fa-cog"></i><span>Process</span></a></li>
                    <li><a href="shortcode-post-sliders.html"><i class="fa fa-picture-o"></i><span>Posts
                                Sliders</span></a></li>
                    <li><a href="shortcode-pricing-tables.html"><i class="fa fa-table"></i><span>Pricing
                                Tables</span></a></li>
                    <li><a href="shortcode-progress-bars.html"><i class="fa fa-bar-chart-o"></i><span>Progress
                                Bars</span></a></li>
                    <li><a href="shortcode-style-changer.html"><i class="fa fa-exchange"></i><span>Style
                                Changer</span></a></li>
                    ...
                    <li><a href="shortcode-testimonials.html"><i
                                class="fa fa-comment"></i><span>Testimonials</span></a></li>
                    <li><a href="shortcode-typography.html"><i class="fa fa-print"></i><span>Typography</span></a>
                    </li>
                </ul>
            </li>
            <li class="menu-item-has-children">
